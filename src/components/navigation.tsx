          ...
          onMouseEnter={(e) => {
            if (!isActive) {
              e.currentTarget.style.backgroundColor =
                transparentBlackColors.hover10;
            }
          }}
          onMouseLeave={(e) => {
            if (!isActive) {
    ...
    <>
      ...
      <motion.nav
        className={`fixed top-0 left-0 right-0 z-[60] transition-all duration-500 ${
          isScrolled ? "shadow-2xl border-b border-white/5 shadow-black/30" : ""
        }`}
        style={{
              ...
              <Link href="/" className="group">
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="flex items-center justify-center">
                    <motion.span className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold tracking-tight whitespace-nowrap leading-none text-white">
                      AGRAWAL CERAMICS
                    </motion.span>
                  </div>
                  ...
                  <div className="mt-0.5 leading-none w-full">
                    <span className="text-[10px] xs:text-xs sm:text-sm text-white/95 font-medium tracking-wide whitespace-nowrap block text-center">
              ...
              >
                <div className="flex flex-col items-center justify-center text-center w-full">
                  ...
                  <div className="flex flex-col items-center w-full">
                    <h3 className="text-sm font-bold whitespace-nowrap text-white">
                      AGRAWAL CERAMICS
                    </h3>
                    <span className="text-[8px] text-white/80 font-medium whitespace-nowrap mt-0.5 text-center">
                      Decorative Tiles & Marbles
                    </span>
                  </div>
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <div className="flex flex-col space-y-1.5">
                      <motion.button
                        ...
                        style={{
                          backgroundColor: `rgba(0, 0, 0, ${
                            TRANSPARENCY.navItemActive + 0.1
                          })`,
                          border: `1px solid ${transparentBlackColors.glassBorder}`,
                          color: "white",
                        }}
                        onMouseEnter={(e) => {
                          e.currentTarget.style.backgroundColor = `rgba(0, 0, 0, ${
                            TRANSPARENCY.navItemActive + 0.2
                          })`;
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor = `rgba(0, 0, 0, ${
                      ...
                      <motion.button
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.backgroundColor = `rgba(0, 0, 0, ${
                            TRANSPARENCY.mobileCard + 0.1
                          })`;
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor =
                            transparentBlackColors.mobileCard;
                        }}
                      >
                        WhatsApp
                      </motion.button>
