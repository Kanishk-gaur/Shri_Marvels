...
export default function GalleryCard({ product, index = 0, priority = false }: GalleryCardProps) {
  ...
  switch (sizeString) {
    ...
    case "6x48": gridClass = "col-span-12 row-span-4 md:col-span-6 md:row-span-6 lg:col-span-12 lg:row-span-8"; break;
    case "4x48": gridClass = "col-span-12 row-span-4 md:col-span-8 md:row-span-5 lg:col-span-12 lg:row-span-7"; break;
    ...
    case "24x4": gridClass = "col-span-24 row-span-5 md:col-span-6 md:row-span-6 lg:col-span-6 lg:row-span-7"; break;
    case "24x2.5": gridClass = "col-span-24 row-span-5 md:col-span-6 md:row-span-6 lg:col-span-6 lg:row-span-6"; break;
    case "24x2": gridClass = "col-span-24 row-span-5 md:col-span-6 md:row-span-5 lg:col-span-6 lg:row-span-6"; break;
