...
export default function GalleryCard({ product, index = 0, priority = false }: GalleryCardProps) {
  ...
  const isImportedBorder = product.subcategory === "Border Tiles" || product.subcategory === "Golden & Silver Border Tiles" || product.subcategory === "Digital Border Tiles" || product.subcategory === "GVT Wall & Floor Border Tiles";
  ...
  switch (sizeString) {
    ...
    case "400x600 mm (16x24 inch)": gridClass = "col-span-12 row-span-9 md:col-span-3 md:row-span-6 lg:col-span-8 lg:row-span-18"; break;
    ...
    case "300x63 mm (12x2.5 inch)": gridClass = "col-span-24 row-span-8 md:col-span-8 md:row-span-12 lg:col-span-6 lg:row-span-8"; break;
    ...
    case "25x600 mm (0.98x23.6 inch)": gridClass = "col-span-24 row-span-5 md:col-span-8 md:row-span-12 lg:col-span-8 lg:row-span-7"; break;
    case "20x600 mm (0.79x23.6 inch)": gridClass = "col-span-24 row-span-5 md:col-span-8 md:row-span-12 lg:col-span-8 lg:row-span-6"; break;
    case "10x600 mm (0.39x23.6 inch)": gridClass = "col-span-24 row-span-4 md:col-span-2 md:row-span-12 lg:col-span-8 lg:row-span-5"; break;
    ...
    case "1200x600 mm (48x24 inch)": gridClass = "col-span-24 row-span-15 md:col-span-8 md:row-span-12 lg:col-span-8 lg:row-span-18"; break;
    ...
    case "12x600 mm (0.47x23.6 inch)": gridClass = "col-span-24 row-span-4 md:col-span-8 md:row-span-12 lg:col-span-8 lg:row-span-5"; break;
    ...
    case "10x450 mm (0.39x17.7 inch)": gridClass = "col-span-24 row-span-5 md:col-span-2 md:row-span-12 lg:col-span-8 lg:row-span-6"; break;
    ...
    case "600x600 mm (24x24 inch)": gridClass = "col-span-12 row-span-14 md:col-span-8 md:row-span-12 lg:col-span-6 lg:row-span-25"; break;
    case "1200x1200 mm (48x48 inch)": gridClass = "col-span-12 row-span-14 md:col-span-8 md:row-span-12 lg:col-span-6 lg:row-span-25"; break;
    ...
    case "12x8 in": gridClass = "col-span-8 row-span-8 md:col-span-6 md:row-span-12 lg:col-span-4 lg:row-span-12"; break;
    case "(God)6x36": gridClass = "col-span-12 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-8 lg:row-span-12"; break;
    case "6x36 in (c)": gridClass = "col-span-24 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-12 lg:row-span-10"; break;
    case "6x36 ,9x36,12x36": gridClass = "col-span-24 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-12 lg:row-span-15"; break;
    case "6x36(w)": gridClass = "col-span-24 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-12 lg:row-span-11"; break;
    case "9x36": gridClass = "col-span-12 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-8 lg:row-span-10"; break;
    case "6x36": gridClass = "col-span-24 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-12 lg:row-span-14"; break;
    case "6x36 in": gridClass = "col-span-24 row-span-6 md:col-span-8 md:row-span-6 lg:col-span-8 lg:row-span-7"; break;
    ...
    case "8x6": gridClass = "col-span-8 row-span-14 md:col-span-8 md:row-span-16 lg:col-span-4 lg:row-span-25"; break;
    
    case "20x600": gridClass = "col-span-24 row-span-5 md:col-span-6 md:row-span-5 lg:col-span-8 lg:row-span-6"; break;
    case "10x600": gridClass = "col-span-24 row-span-6 md:col-span-6 md:row-span-5 lg:col-span-8 lg:row-span-5"; break;
    ...
    case "6x48": gridClass = "col-span-24 row-span-6 md:col-span-6 md:row-span-6 lg:col-span-12 lg:row-span-8"; break;
    case "4x48": gridClass = "col-span-24 row-span-6 md:col-span-8 md:row-span-5 lg:col-span-12 lg:row-span-7"; break;
    ...
    case "24x4": gridClass = "col-span-24 row-span-7 md:col-span-6 md:row-span-6 lg:col-span-6 lg:row-span-7"; break;
    case "24x2.5": gridClass = "col-span-24 row-span-6 md:col-span-6 md:row-span-6 lg:col-span-6 lg:row-span-6"; break;
    case "24x2": gridClass = "col-span-24 row-span-6 md:col-span-6 md:row-span-5 lg:col-span-6 lg:row-span-6"; break;
    case "12x2.5": gridClass = "col-span-12 row-span-6 md:col-span-6 md:row-span-6 lg:col-span-6 lg:row-span-8"; break;
    case "24x1": gridClass = "col-span-24 row-span-4 md:col-span-6 md:row-span-5 lg:col-span-6 lg:row-span-5"; break;
    ...
    case "200x300 mm (8x12 inch)": gridClass = "col-span-8 row-span-14 md:col-span-4 md:row-span-16 lg:col-span-4 lg:row-span-25"; break;
    case "2x3": gridClass = "col-span-12 row-span-20 md:col-span-4 md:row-span-16 lg:col-span-4 lg:row-span-25"; break;
    ...
    case "300x200 mm (12x8 inch)": gridClass = "col-span-12 row-span-10 md:col-span-6 md:row-span-12 lg:col-span-6 lg:row-span-17"; break;
    case "3x2": gridClass = "col-span-12 row-span-10 md:col-span-6 md:row-span-12 lg:col-span-6 lg:row-span-17"; break;
    case "6x8": gridClass = "col-span-12 row-span-10 md:col-span-4 md:row-span-12 lg:col-span-3 lg:row-span-16"; break;
    case "24x3": gridClass = "col-span-24 row-span-6 md:col-span-6 md:row-span-4 lg:col-span-6 lg:row-span-6"; break;
