 ...
 // Default is now col-span-12 (half of 24) instead of col-span-6 (half of 12)
  ...
  switch (sizeString) {
    case "600x1200 mm (24x48 inch)":
      gridClass =
        "col-span-12 row-span-26 md:col-span-8 md:row-span-12 lg:col-span-4 lg:row-span-32";
      break;
    ...
    case "300x450 mm (11.8x17.7 inch)":
      gridClass =
        "col-span-12 row-span-11 md:col-span-8 md:row-span-12 lg:col-span-6 lg:row-span-19";
      break;
    ...
    case "25x600 mm (0.98x23.6 inch)":
      gridClass =
        "col-span-24 row-span-5 md:col-span-8 md:row-span-12 lg:col-span-6 lg:row-span-7";
      break;
    ...
    case "900x600 mm (36x24 inch)":
      gridClass =
        "col-span-24 row-span-20 md:col-span-8 md:row-span-12 lg:col-span-6 lg:row-span-18";
      break;
    case "24x24 inch":
      gridClass =
    ...
    case "600x600 mm (24x24 inch)":
      gridClass =
        "col-span-12 row-span-14 md:col-span-8 md:row-span-12 lg:col-span-4 lg:row-span-18";
      break;
    ...
    case "6x36(w)":
      // Was 6 -> 12
      gridClass =
        "col-span-12 row-span-8 md:col-span-4 md:row-span-10 lg:col-span-6 lg:row-span-5";
      break;
    case "9x36":
      // Was 6 -> 12
      gridClass =
    ...
    case "6x48":
      // Was 6 -> 12
      gridClass =
        "col-span-12 row-span-5 md:col-span-6 md:row-span-6 lg:col-span-8 lg:row-span-7";
      break;
    case "4x48":
      // Was 6 -> 12
      gridClass =
        "col-span-12 row-span-5 md:col-span-8 md:row-span-5 lg:col-span-12 lg:row-span-6";
      break;
    case "4x2":
      // Was 3 -> 6
      gridClass =
    ...
    case "8x12 inches":
      // Was 6 -> 12
      gridClass =
        "col-span-12 row-span-14 md:col-span-4 md:row-span-11 lg:col-span-4 lg:row-span-18";
      break;
    case "8x12":
      // Was 3 -> 6
      gridClass =
        "col-span-6 row-span-11 md:col-span-4 md:row-span-16 lg:col-span-4 lg:row-span-25";
      break;
    case "12x8":
      // Was 6 -> 12
      gridClass =
