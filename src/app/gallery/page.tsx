...
export default function GalleryPage() {
 ...
 return (
    <div className="min-h-screen bg-orange-50 pt-16">
      ...
      >
        {/* --- FIXED SECTION: Header and Filters --- */}
        <div className="fixed top-16 left-0 right-0 z-50 bg-orange-50 border-b border-zinc-200">
          <motion.div
          ...
          <div className="max-w-screen-2xl mx-auto px-4 pb-4">
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-lg p-4 border border-zinc-200/80">
        ...
        {/* --- SCROLLABLE SECTION: Images Only --- */}
        {/* REDUCED pt-[260px] (was 320px) to pull items upward closer to filters */}
        <main className="pt-[260px] max-w-screen-2xl mx-auto px-4 sm:px-6">
          {/* REDUCED mt-2 (was 8) for a tighter layout */}
          <motion.div
            className="mt-2"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
