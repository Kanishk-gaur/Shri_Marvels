...
function getGridDimensions(sizeString: string) {
  ...
  switch (sizeString) {
    ...
    case "400x600 mm (16x24 inch)": colSpan = 16; rowSpan = 26; break;
    case "(LUSTER)12x24":
    case "(SUGAR)12x24": colSpan = 8; rowSpan = 11; break;
    case "(Sugar)300x600 mm (11.8x23.6 inch)":colSpan = 12; rowSpan = 20; break;
    case "(GLUE)300x600 mm (11.8x23.6 inch)":colSpan = 12; rowSpan = 20; break;
    case "Polishing Series 300x600 mm (12x24 inch)":colSpan = 12; rowSpan = 20; break;
    case "300x600 mm (11.8x23.6 inch)": colSpan = 12; rowSpan = 20; break;
    case "300x63 mm (12x2.5 inch)": colSpan = 12; rowSpan = 8; break;
    case "600x1200 mm (24x48 inch)": colSpan = 6; rowSpan = 40; break;
    case "300x450 mm (11.8x17.7 inch)": colSpan = 12; rowSpan = 24; break;
    ...
    case "12x8, 18x12, 24x18, 2x2, 3x2, 4x2": colSpan = 12; rowSpan = 26; break;
    case "24x24 inch":colSpan = 8; rowSpan = 30; break;
    case "600x600 mm":colSpan = 8; rowSpan = 30; break;
    case "600x600 mm (23.6x23.6 inch)":colSpan = 8; rowSpan = 30; break;
    case "600x600 mm (24x24 inch)":colSpan = 8; rowSpan = 30; break;
    case "1200x1200 mm (48x48 inch)": colSpan = 12; rowSpan = 40; break;
    case "600x900 mm": colSpan = 8; rowSpan = 38; break;
    case "600x900 mm (24x36 inch)": colSpan = 8; rowSpan = 38; break;
    case "8x12, 12x18, 18x24, 2x2, 2x3, 2x4": colSpan = 8; rowSpan = 45; break;
    case "1200x600 mm":colSpan = 12; rowSpan = 26; break;
    case "1200x600 mm (48x24 inch)": colSpan = 12; rowSpan = 26; break;
    ...
    case "12x8 in": colSpan = 8; rowSpan = 16; break;
    ...
    case "600x1200 mm": colSpan = 6; rowSpan = 40; break;
    case "2x4": colSpan = 6; rowSpan = 40; break;
    case "4x6": colSpan = 12; rowSpan = 24; break;
    ...
    case "8x12 inches": colSpan = 8; rowSpan = 30; break;
    case "8x12": colSpan = 6; rowSpan = 24; break;
    case "12x8": colSpan = 8; rowSpan = 13; break;
    case "18x12": colSpan = 8; rowSpan = 14; break;
    case "2x2": colSpan = 8; rowSpan = 30; break;
    case "200x300 mm (8x12 inch)": colSpan = 8; rowSpan = 38; break;
    case "2x3": colSpan = 8; rowSpan = 38; break;
    case "6x3": colSpan = 6; rowSpan = 12; break;
    case "8x4": colSpan = 4; rowSpan = 12; break;
    case "3x2/24x18/2x2": colSpan = 12; rowSpan = 27; break;
    case "300x200 mm (12x8 inch)": colSpan = 12; rowSpan = 24; break;
